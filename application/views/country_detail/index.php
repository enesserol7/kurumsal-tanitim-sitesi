...
<head>
<?php $this->load->view("country_detail/includes/head"); ?>
</head>
<body>
	<!-- Background -->
...
<?php $this->load->view("includes/header"); ?>
		...
		<div id="content">
			<div class="inner-content">
				...
				<!-- Content sections 
					================================================== -->
<?php $this->load->view("country_detail/includes/content_sections"); ?>
...
<?php $this->load->view("includes/footer"); ?>
	...
	<!-- End Container -->
<?php $this->load->view("country_detail/includes/include_script"); ?>
</body>
</html>